...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      >
        <nav className="shadow-md font-sans tracking-wide relative z-50">
          <section className="py-2 bg-[#007bff] text-white text-right px-10">
            <p className="text-sm">
              <strong className="mx-3">Address:</strong>SWF New York 187669
              <strong className="mx-3">Contact No:</strong>320333665
            </p>
          </section>
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 px-10 py-4 bg-white min-h-[70px]">
            <div className="flex inline-flex gap-4 items-center">
              <Image src={logoIcon} alt="logo" className="w-12" />
              <p className="text-black-500 font-semibold text-[24px]">
                Chicken Alfredo
              </p>
            </div>
